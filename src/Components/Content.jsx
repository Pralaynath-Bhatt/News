 ...
 const Content = ({category,country,search}) => {
  ...
  return (
    ...
    {articles.map((news,index)=>{
      ...
      return <News key={index} title={news.title} description={news.description} src={news.urlToImage} url={news.url} site={news.source.name} author={news.author} publishedAt={news.publishedAt}/>
 })}
    </div>
  )
}
